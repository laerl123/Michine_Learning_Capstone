...
public class csh1stCalculator : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        traffic[0] = (int)(CCTV[0].GetComponent<cshCCTVData>().congestion / 100.0f * max[0]);
        ...
        CCTV[0].GetComponent<cshCCTVData>().velocity =
            Mathf.Ceil(-40.8f * (CCTV[0].GetComponent<cshCCTVData>().congestion / 100.0f) + 100.6f);
